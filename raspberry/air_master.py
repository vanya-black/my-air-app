...
DB_NAME = Path(Path.home(), 'my-air-app', 'air.db')
REQUEST_INTERVAL = 5

logging.basicConfig(filename=Path(Path.home(), 'my-air-app', 'air_maste.log'), encoding='utf-8', level=logging.DEBUG, format='%(asctime)s:%(levelname)s:%(name)s:%(message)s')
